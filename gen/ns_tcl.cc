...
\"\n\
checkout_executable TCLSH \"/home/toby/Downloads/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/toby/Downloads/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
Application/Traffic/Exponential set rate_ 640Kb\n\
Application/Traffic/Exponential set packetSize_ 536\n\
\n\
DataCenter set tskSubmitted_ 0\n\
DataCenter set avgLoad_ 0\n\
\n\
DcHost set host_id_ 0\n\
...
Application/Traffic/ExpCloudUser set packetSize_ 1500\n\
...
Application/Traffic/CBRCloudUser set packetSize_ 1500\n\
