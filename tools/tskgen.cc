...
static const char rcsid[] =
    "@(#) $Header: /cvsroot/nsnam/ns-2/tools/tskgen.cc,v 1.15  Exp $ (Xerox)";
#endif
...
class TASK_Traffic : public TrafficGenerator {
 public:
	TASK_Traffic();
...
static class TaskGenClass : public TclClass {
 public:
	TaskGenClass() : TclClass("Application/Traffic/TaskGen") {}
	TclObject* create(int, const char*const*) {
		return (new TASK_Traffic());
	}
} class_task_gen;
...
int TASK_Traffic::command(int argc, const char*const* argv){
...
TASK_Traffic::TASK_Traffic() : burstlen_(0.0), Offtime_(0.0)
{
...
// ADDED CODE
//	if (user_)
//		user_->set_pkttype(PT_EXP);
// ADDED CODE
}

double TASK_Traffic::next_interval(int& size)
{
	double t = interval_;
