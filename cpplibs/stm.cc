...
class STM_Traffic : public TrafficGenerator {
 public:
	STM_Traffic();
...
static class STMTrafficClass : public TclClass {
 public:
	STMTrafficClass() : TclClass("Application/Traffic/STM") {}
	TclObject* create(int, const char*const*) {
		return (new STM_Traffic());
	}
} class_stm_traffic;

STM_Traffic::STM_Traffic() : seqno_(0)
{
	bind_bw("rate_", &rate_);
...
double STM_Traffic::next_interval(int& size)
{
